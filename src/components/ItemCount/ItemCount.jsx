...
const ItemCount = ({ stock, initial, onAdd }) => {
    ...
    return (
        ...
        <div className="flex space-x-4  text-base font-medium">
            ...
            <button onClick={() => onAdd(productNumber)} className="flex-none flex items-center justify-center w-9 h-9 rounded-md bg-slate-100 text-orange-400 border border-orange-200" type="button" aria-label="Like">
